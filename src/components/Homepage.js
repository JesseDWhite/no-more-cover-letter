        ...
        <div className='row'>
          <div className='col-12'>
            <div className='card homepage-card'>
              ...
              <p>
                A good cover letter and resume will make it easier to see how your skills and
                experience match an employer's job description.
                Many companies use automated tools such as an Applicant Tracking System (ATS) to scan cover
                letters and resumes for keywords and power words that match their job descriptions,
                then automatically reject applications that don't have those words. This can be an important barrier
                to get past in order to schedule an interview.
              </p>
              <p>
                ...
                phrases from the job description in your cover letter. Even you lack experience with a qualification, it
                is still important to touch on it.
              </p>
              <p>
                ...
                power words and keywords when you see them. For a programming job,
                these kinds of words might include coding languages,
              ...
              <p>
                ...
                hiring manager or the ATS program will notice.
